 ...
 * function:
 */
public class HuntAdapter extends RecyclerView.Adapter<HuntAdapter.MyViewHolder> {
    private Context context;
    private List<Hunt> list;
    ...
    public void addAll(List<Hunt> data){
        if (data!=null){
            list.addAll(data);
        }
    }
    @NonNull
    @Override
    public HuntAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        inflate = LayoutInflater.from(context).inflate(R.layout.stateofanillness_layout, parent, false);
        return new MyViewHolder(inflate);
    }

    @Override
    public void onBindViewHolder(@NonNull HuntAdapter.MyViewHolder holder, final int position) {
